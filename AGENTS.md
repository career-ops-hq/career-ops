...
| Wants a hiring-manager's read on a tailored CV before sending | `cv-hm-audit` — researches the likely reviewer, dispatches a separate agent role-playing them, returns a bullet-by-bullet keep/cut/rewrite verdict |
