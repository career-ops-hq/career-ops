...
- **Başvuruyu otomatik göndermek.** Her alan için cevabı taslak olarak hazırlar; sen kontrol eder ve Gönder'e tıklarsın. Betik asla POST yapmaz (`prepare-application.mjs`).
