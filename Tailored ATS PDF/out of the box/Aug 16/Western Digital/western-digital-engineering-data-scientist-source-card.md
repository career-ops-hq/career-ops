# Source card — Western Digital · Engineering Data Scientist
**Score:** 2.5/5  ·  **ATS projection (post-tailor):** 85/100
...
- ✓ **Bridging the gap between AI technology and business problems with a product mindset** — matched: technology, business, problems, product, mindset
- ✓ **Multi-layered Agentic RAG & ground-truth evaluation (reduced search time by 90%)** — matched: time
- ✓ **Taking ownership and quickly adapting to new LLMs/technologies** — matched: technologies
