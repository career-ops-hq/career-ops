...
6. Detect company location → paper format. Skip this when `config/profile.yml` sets `page_format`; that is the user's standing answer and it already reaches every renderer.
   - US/Canada → `letter`
