...
1. **Спробуйте спрогнозувати ймовірні питання**, спираючись на:
   ...
   - Те те, що викликало найбільший інтерес інтерв'юера в поточному раунді

   Позначайте кожен прогноз як `[виведено]` (inferred) — ніколи не видавайте спрогнозоване питання за реальне, отримане від інших кандидатів чи інсайдерів компанії.
