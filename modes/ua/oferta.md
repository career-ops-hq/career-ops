...
Назви колонок писати **англійською, точно як вище** — `merge-tracker.mjs` зіставляє поля за ІМЕНЕМ, тому порядок колонок значення не має, а значення не може потрапити не в ту колонку.
