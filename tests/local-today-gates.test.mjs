...
//
// The scan-history WRITERS are here for the same reason even though they stamp
// rather than compare: the value they stamp is read back as a gate. See the
// scan-history section at the bottom of this file.
//
