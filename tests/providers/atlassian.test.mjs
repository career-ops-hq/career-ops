...
try {
  ...
  const LISTING = {
    ...
    applyUrl: 'https://jobs.atlassian.com/job/25583',
    portalJobPost: { id: 25583, portalUrl: 'https://www.atlassian.com/company/careers/details/25583', updatedDate: '2026-09-11 01:00 AM' },
  };

  {
    ...
    jobs.length === 1
      ...
      && j.url === 'https://jobs.atlassian.com/job/25583'
      && j.company === 'Atlassian'
