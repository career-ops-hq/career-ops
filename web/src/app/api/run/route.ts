...
export async function POST(req: Request) {
  ...
  // and even after a client disconnect fires cancel(). Track those promises so
  // cancel() can defer releasing writeToken until that work actually settles,
  // instead of releasing the tracker-delete guard while mark-pdf-ready.mjs or
  // the evaluate persist is still writing applications.md.
