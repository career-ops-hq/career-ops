...
export async function POST(req: Request) {
  ...
  // The precondition must check the files the prompt/backend will actually read.
  // Evaluation is locale-aware, and pdf mode needs both the HTML builder and the
  // Chromium renderer present in the checkout.
