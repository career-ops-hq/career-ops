...
export function rankOffers(offers: AutomationOffer[], watch: Partial<CareerWatch>, now?: Date): RankedAutomationOffer[];
export function isWatchDue(watch: Partial<CareerWatch>, lastRunAt: string | null, now?: Date): boolean;
