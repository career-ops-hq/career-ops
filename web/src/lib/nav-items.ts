import { LayoutDashboard, Compass, ListChecks, Send, Radar, BarChart3, FileText, Settings, Briefcase } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/studio", label: "Studio", icon: Briefcase, chip: "LinkedIn" },
