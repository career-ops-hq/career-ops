import { LayoutDashboard, Compass, ListChecks, Send, Radar, BarChart3, FileText, Files, Settings, UserRoundPen } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/profile/update", label: "Update Career Profile", icon: UserRoundPen },
