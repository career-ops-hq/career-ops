const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/jobs/intelligence",
        label: "Jobbintelligens",
        description: "AI-analys och matchning av jobbannonsers krav mot din profil.",
        keywords: ["analys", "match", "jobb", "annons", "intelligens"],
      ...
      },
      {
        href: "/watch",
        label: "Bevakningar",
        description: "Låt Career-Ops hitta och AI-ranka nya jobb automatiskt.",
        keywords: ["bevakning", "automatiskt", "distansjobb", "hybrid", "på plats", "resande"],
        iconKey: "watch",
        chip: "AI",
        shortcut: "G B",
      },
      ...
      },
      {
        ...
        label: "Ansökningsstudio",
        description: "Skapa personliga brev, motivation och meddelanden från verifierade fakta.",
        keywords: ["ansökan", "brev", "motivation", "meddelande", "studio", "recruiter", "linkedin", "intervju", "tack"],
        iconKey: "apply",
        chip: "Ny",
        shortcut: "G S",
      },
      {
        href: "/email-hub",
        label: "E-posthubb",
        description: "Klassificera jobbmejl, koppla till pipeline och förbered svar — ingen e-post skickas utan godkännande.",
        keywords: ["epost", "email", "mejl", "klassificering", "recruiter", "intervju", "erbjudande", "connector"],
        iconKey: "mail",
        chip: "Ny",
        shortcut: "G E",
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        href: "/cv/tailor",
        label: "CV-anpassning",
        description: "Skapa jobbanpassade CV-versioner med AI-stöd och ändringsgranskning.",
        keywords: ["cv", "anpassa", "tailoring", "skräddarsy", "ändringsgranskning", "ats"],
        iconKey: "cv",
        chip: "AI",
        shortcut: "G T",
      },
