...
test("Create New Version sends General Role prompts through stdin", () => { assert.match(route, /promptViaStdin = cliId === "codex" && kind === "role-resume"/); assert.match(route, /stdinMode: "pipe", stdinInput: prompt/); });
